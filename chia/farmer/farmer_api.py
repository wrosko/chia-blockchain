...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        ...
        for sp in sps:
            ...
            og_mgr = self.farmer.og_pooling_manager
            if pool_public_key is not None and og_mgr is not None and og_mgr.is_pooling_enabled:
                await og_mgr.process_new_proof_of_space_for_og_pool(
                    new_proof_of_space,
                    peer,
                    pool_public_key,
                    computed_quality_string,
    ...
    async def new_signage_point(self, new_signage_point: farmer_protocol.NewSignagePoint) -> None:
        ...
        try:
            ...
            if self.farmer.og_pooling_manager is not None and self.farmer.og_pooling_manager.is_pooling_enabled:
                ...
                difficulty = self.farmer.og_pooling_manager.current_difficulty
